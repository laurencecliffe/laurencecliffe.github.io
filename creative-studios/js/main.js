...
var modelList = [
            {
                name: "bonePlate.obj", url: 'sample_models/bonePlate.obj'
            },
            {
                name: "cuttingGuide.obj", url: 'sample_models/cuttingGuide.obj'
            },
            {
                name: "PostOsteotomyRadialWedge.obj", url: 'sample_models/PostOsteotomyRadialWedge.obj'
                //, objectRotation: new THREE.Euler(0, 3 * Math.PI / 2, 0)

            },
            {
                name: "PostOsteotomyRadiusUlnaL.obj", url: 'sample_models/PostOsteotomyRadiusUlnaL.obj'
            },
            {
                name: "PreOsteotomyRadiusUlnaL.obj", url: 'sample_models/PreOsteotomyRadiusUlnaL.obj'
            }
